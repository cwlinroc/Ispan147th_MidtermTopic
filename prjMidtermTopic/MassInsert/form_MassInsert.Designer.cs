namespace prjMidtermTopic.MassInsert
{
	partial class form_MassInsert
	{
		...
		private void InitializeComponent()
		{
			...
			this.btn_AddMerchanDise = new System.Windows.Forms.Button();
			this.textBox_Merchandise = new System.Windows.Forms.TextBox();
			this.label4 = new System.Windows.Forms.Label();
			this.btn_AddThemeCommon = new System.Windows.Forms.Button();
			this.textBox_ThemeAndCommon = new System.Windows.Forms.TextBox();
			this.label5 = new System.Windows.Forms.Label();
			this.btn_AddOrderOrderList = new System.Windows.Forms.Button();
			this.textBox_OrderAndOrderList = new System.Windows.Forms.TextBox();
			this.label6 = new System.Windows.Forms.Label();
			this.btn_AddAdopt = new System.Windows.Forms.Button();
			this.textBox_Adopt = new System.Windows.Forms.TextBox();
			this.label7 = new System.Windows.Forms.Label();
			this.btn_AddForumAccount = new System.Windows.Forms.Button();
			this.txt_ForumAccount = new System.Windows.Forms.TextBox();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.btn_AddMerchanDise.Click += new System.EventHandler(this.btn_AddMerchanDise_Click);
			// 
			// textBox_Merchandise
			// 
			...
			this.btn_AddThemeCommon.Click += new System.EventHandler(this.btn_AddThemeCommon_Click);
			// 
			...
			this.btn_AddOrderOrderList.Click += new System.EventHandler(this.btn_AddOrderOrderList_Click);
			// 
			...
			this.btn_AddAdopt.Click += new System.EventHandler(this.btn_AddAdopt_Click);
			// 
			// textBox_Adopt
			// 
			...
			this.btn_AddForumAccount.Click += new System.EventHandler(this.btn_AddForumAccount_Click);
			// 
			// txt_ForumAccount
			// 
			...
			this.Controls.Add(this.txt_ForumAccount);
			this.Controls.Add(this.textBox_Merchandise);
			this.Controls.Add(this.textBox_Pet);
			this.Controls.Add(this.textBox_Member);
			this.Controls.Add(this.btn_AddAdopt);
			this.Controls.Add(this.label6);
			this.Controls.Add(this.btn_AddOrderOrderList);
			this.Controls.Add(this.label5);
			this.Controls.Add(this.btn_AddThemeCommon);
			this.Controls.Add(this.label4);
			this.Controls.Add(this.btn_AddForumAccount);
			this.Controls.Add(this.label7);
			this.Controls.Add(this.btn_AddMerchanDise);
		...
		private System.Windows.Forms.Button btn_AddMerchanDise;
		private System.Windows.Forms.TextBox textBox_Merchandise;
		private System.Windows.Forms.Label label4;
		private System.Windows.Forms.Button btn_AddThemeCommon;
		private System.Windows.Forms.TextBox textBox_ThemeAndCommon;
		private System.Windows.Forms.Label label5;
		private System.Windows.Forms.Button btn_AddOrderOrderList;
		private System.Windows.Forms.TextBox textBox_OrderAndOrderList;
		private System.Windows.Forms.Label label6;
		private System.Windows.Forms.Button btn_AddAdopt;
		private System.Windows.Forms.TextBox textBox_Adopt;
		private System.Windows.Forms.Label label7;
		private System.Windows.Forms.Button btn_AddForumAccount;
		private System.Windows.Forms.TextBox txt_ForumAccount;
	}
}