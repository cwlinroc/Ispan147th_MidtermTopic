...
{
	public partial class form_EditSpec : Form
	{
		...
		private void form_EditSpec_Load(object sender, EventArgs e)
		{
			SpecDto dto = _repo.GetBySpecID(_specId);
			if (dto == null)
			{
			...
			txt_SpecId.Text = dto.SpecId.ToString();
			txt_SpecName.Text = dto.SpecName.ToString();
